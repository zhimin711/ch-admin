<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="客户端版本" min-width="200" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.ip }}</span>
        </template>
      </el-table-column>
      <el-table-column label="应用名" min-width="100" align="center">
        <template slot-scope="scope">
          {{ scope.row.adminPort }}
        </template>
      </el-table-column>
...
<script>
import { addNodeServer, getNodeServers, updateNodeServer, deleteNodeServer, startNodeServer, stopNodeServer } from '@/api/canal/nodeServer'
