...
<script>
import { addNacosNamespaces, getNacosNamespace, updateNacosNamespaces, deleteNacosNamespaces } from '@/api/nacos/namespace'
import { pageApplyNamespaces } from '@/api/nacos/applyNamespace'
