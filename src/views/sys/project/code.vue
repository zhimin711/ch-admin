<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button v-permission="['SYS_PROJECT_CODE_SEARCH']" class="filter-item" type="primary" icon="el-icon-search" @click="getList">
        查询
      </el-button>
      <el-button class="filter-item" type="default" icon="el-icon-refresh" @click="listQuery.params = {}">
        重置
      </el-button>
      <el-button v-permission="'SYS_PROJECT_CODE_ADD'" class="filter-item" style="margin-left: 10px;" type="primary" icon="el-icon-plus" @click="handleAdd">
        添加项目
      </el-button>
    </div>
