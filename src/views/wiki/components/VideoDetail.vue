  ...
  <div class="createPost-container">
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      ...
      <sticky :z-index="10" :class-name="'sub-navbar '+stickyStatus">
        <CategoryDropdown v-model="categoryValues" type="86" placeholder="视频分类" />
      ...
      <div class="createPost-main-container">
        <el-row>
          ...
          <el-col :span="24">
            ...
            <div class="postInfo-container">
              <el-row>
                <el-col :span="8">
                  <el-form-item label-width="100px" label="发布者:" class="postInfo-container-item">
                ...
                <el-col :span="8">
                  <el-form-item label-width="90px" label="视频标签:" class="postInfo-container-item__block">
                    <el-select
                      v-model="tags.values"
                      multiple
                      filterable
        ...
        <el-form-item style="margin-bottom: 40px;" label-width="100px" label="视频简介:">
        ...
        <el-form-item prop="image" style="margin-bottom: 30px;" label-width="100px" label="封面:">
          <el-row>
            <el-col :span="24">
              <Upload v-model="postForm.image" dir="wiki" title="视频封面裁剪及上传" :data="{srcType: 'VIDEO_COVER', action: 'scale'}" />
            </el-col>
          </el-row>
        </el-form-item>
        <el-form-item prop="content" style="margin-bottom: 30px;" label-width="100px" label="视频源:">
          <UploadSingleFile v-model="postForm.srcUrl" :data="{srcType: 'VIDEO', 'type':'2'}" @success="uploadSuccess" />
        </el-form-item>
...
export default {
  ...
  components: { UploadSingleFile, MDinput, Upload, Sticky, CommentDropdown, CategoryDropdown },
  props: {
    isEdit: {
      type: Boolean,
      default: false
